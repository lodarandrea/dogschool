...
function Card({ title, description, imgSrc }: CardProps) {
  return (
    <div className="flex mx-10 rounded-3xl border-white px-2 py-2 items-center justify-start hover:bg-turquoise-400/10 hover:rounded-3xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105">

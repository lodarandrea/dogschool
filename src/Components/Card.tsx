...
function Card({ title, description, imgSrc }: CardProps) {
  return (
    <div className="flex mx-10 rounded-3xl border-white lg:flex-col lg:h-80 lg:rounded-lg lg:w-full lg:border-neutral-200 lg:border-2 lg:mx-2 lg:my-5 lg:shadow-xl lg:hover:rounded-xl p-2 items-center justify-start hover:bg-turquoise-400/10 hover:rounded-3xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105">
